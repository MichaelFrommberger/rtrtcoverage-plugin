...
_ATC_DECLARE(1,0x1F7F6F57UL,0x4E2E7F6AUL,2,_ATC_TAB_PROC(1),0,0,10,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_airportSelected.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_airportSelected.c"
...
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_airportSelected.c"
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_airportSelected.c"
#line 25 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_airportSelected.c"
...
#line 26 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_airportSelected.c"
...
#line 27 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_airportSelected.c"
...
void AirportManager_airportSelected(AirportManager *pThis, T_int16 pAirportRequest)
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,9);{
	...
	{_ATC_BLOC(1,7);{
		...
		switch (pThis->_mode)
		{
			...
			{
				if (pThis->_requestedAirportForDisplay != pAirportRequest)
				{_ATC_BLOC(1,1);{
					 


					pThis->_requestedAirportForDisplay = pAirportRequest;

					pThis->_airportToBeDisplayedInPlan = pAirportRequest;
					pThis->_lastDisplayedAirportInPlan = pAirportRequest;
					pThis->_updateAirportPriorityList(pThis);
				...
				if (pThis->_transitionPerformed ==  1 )
				{_ATC_BLOC(1,3);{
					pThis->_airportDisplayedInPlanAfterTransition =  1 ;
				}}
				else
				{_ATC_BLOC(1,4);{
					pThis->_airportDisplayedInPlanAfterTransition =  0 ;
				}}
			}}
			break;

			case E_ARC_MODE:
			case E_NAV_MODE:{_ATC_BLOC(1,5);
			{
				pThis->_airportToBeDisplayedInPlan = pAirportRequest;
				pThis->_memorizedAirportInArcNav = pAirportRequest;
			}}
			break;
