...
_ATC_DECLARE_BLOC(1,15)
_ATC_DECLARE(1,0x41383D12UL,0x96A0B0AUL,2,_ATC_TAB_PROC(1),0,0,15,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAirportToBeDisplayedInArcNav.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAirportToBeDisplayedInArcNav.c"




 
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAirportToBeDisplayedInArcNav.c"
...
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAirportToBeDisplayedInArcNav.c"
#line 25 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAirportToBeDisplayedInArcNav.c"
#line 26 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAirportToBeDisplayedInArcNav.c"
...
#line 27 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAirportToBeDisplayedInArcNav.c"
...
#line 28 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAirportToBeDisplayedInArcNav.c"
...
void AirportManager__updateAirportToBeDisplayedInArcNav(AirportManager *pThis)
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,14);{
	...
	T_float32 lAirportLatitude = 0.0f;
	T_float32 lAirportLongitude = 0.0f;
	T_float32 lAirportAltitude = 0.0f;
	T_boolean lIsInAirportCoverageVolume =  0 ;

	if (pThis->_aircraftLocationValidity ==  1 )
	{_ATC_BLOC(1,12);{
		 
		if (pThis->_onGroundCondition ==  1 )
		{_ATC_BLOC(1,2);{
			if (pThis->_nearestAirport !=  -1 )
			{_ATC_BLOC(1,0);{
				pThis->_airportToBeDisplayedInArcNav = pThis->_nearestAirport;
			}}
			else
			{_ATC_BLOC(1,1);{
				pThis->_airportToBeDisplayedInArcNav =  -1 ;
			}}
		}}
		...
		{_ATC_BLOC(1,11);{
			...
			{_ATC_BLOC(1,3);{
				...
				lAirportLatitude = lMapObjectServices->getFloatData(lMapObjectServices, lDestinationAirportObject,  3 );
				lAirportLongitude = lMapObjectServices->getFloatData(lMapObjectServices, lDestinationAirportObject,  4 );
				lAirportAltitude = lMapObjectServices->getFloatData(lMapObjectServices, lDestinationAirportObject,  2 );

				lIsInAirportCoverageVolume = CGeometricTools->isLatLongInAirportCoverageVolume(pThis->_aircraftLatitude, pThis->_aircraftLongitude,
																								pThis->_aircraftAltitude, lAirportLatitude,
																								lAirportLongitude, lAirportAltitude,  ((T_ptr)0) );
			}}
			else
			{_ATC_BLOC(1,4);{
				lIsInAirportCoverageVolume =  0 ;
			}}

			 
			if (lIsInAirportCoverageVolume ==  1 )
			{_ATC_BLOC(1,5);{
				pThis->_airportToBeDisplayedInArcNav = pThis->_destinationAirport;
			}}
			else
			{_ATC_BLOC(1,10);{
				...
				{_ATC_BLOC(1,6);{
					...
					lAirportLatitude = lMapObjectServices->getFloatData(lMapObjectServices, lOriginAirportObject,  3 );
					lAirportLongitude = lMapObjectServices->getFloatData(lMapObjectServices, lOriginAirportObject,  4 );
					lAirportAltitude = lMapObjectServices->getFloatData(lMapObjectServices, lOriginAirportObject,  2 );
				...
				if (lIsInAirportCoverageVolume ==  1 )
				{_ATC_BLOC(1,8);{
					pThis->_airportToBeDisplayedInArcNav = pThis->_originAirport;
				}}
				else
				{_ATC_BLOC(1,9);{
					pThis->_airportToBeDisplayedInArcNav =  -1 ;
