...
_ATC_DECLARE_BLOC(1,12)
_ATC_DECLARE(1,0x1D090512UL,0x614325CUL,2,_ATC_TAB_PROC(1),0,0,12,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateMapManagementData.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateMapManagementData.c"
...
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateMapManagementData.c"
...
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateMapManagementData.c"
#line 25 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateMapManagementData.c"
#line 26 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateMapManagementData.c"
...
#line 27 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateMapManagementData.c"
...
#line 28 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateMapManagementData.c"
...
void AirportManager__updateMapManagementData(AirportManager *pThis)
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,11);{
	...
	MapObjectServices *lWorkingAirportObject =  ((T_ptr)0) ;
	T_int16 lWorkingAirport =  -1 ;
	...
	switch (pThis->_mode)
	{
		...
		{
			lWorkingAirport = pThis->_requestedAirportForDisplay;

			if (pThis->_requestedAirportForDisplay == pThis->_airportToBeDisplayedInArcNav)
			{_ATC_BLOC(1,1);{
				SAME_ARPT_PLAN_AS_ROSENAV =  1 ;
			}}
			else
			{_ATC_BLOC(1,2);{
		...
		case E_ARC_MODE:
		case E_NAV_MODE:{_ATC_BLOC(1,3);
		{
			lWorkingAirport = pThis->_airportToBeDisplayedInPlan;
		...
		default:{_ATC_BLOC(1,6);
			 
		break;}
	}

	if (lWorkingAirport !=  -1 )
	{_ATC_BLOC(1,9);{
		...
		lMapObjectServices =
					(MapObjectServices*)(lAirportManagerComponent->getConnectedFacet(lAirportManagerComponent,
														E_AIRPORT_MANAGER_MAP_OBJECT_SERVICES_RECEPTACLE_INDEX));
		lWorkingAirportObject = lDatabaseServices->getAirportInstance(lDatabaseServices, lWorkingAirport);
		ARPLATITUDE = (T_FLOAT)(lMapObjectServices->getFloatData(lMapObjectServices, lWorkingAirportObject,  3 ));
		ARPLONGITUDE = (T_FLOAT)(lMapObjectServices->getFloatData(lMapObjectServices, lWorkingAirportObject,  4 ));

		 
		if (pThis->_aircraftLocationValidity ==  1 )
		{_ATC_BLOC(1,7);{
			AC_IN_BOUNDING_BOX = CGeometricTools->isLatLongInAirportBoundingBox(pThis->_aircraftLatitude, pThis->_aircraftLongitude,
																				lWorkingAirportObject, lMapObjectServices);
		}}
		else
		{_ATC_BLOC(1,8);{
