...
_ATC_DECLARE(1,0x187C6049UL,0x63155D0FUL,2,_ATC_TAB_PROC(1),0,0,3,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_execute.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_execute.c"
...
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_execute.c"
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_execute.c"
...
#line 25 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_execute.c"
...
void AirportManager_execute(AirportManager *pThis)
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,2);{
     
	AirportManagerComponent *lAirportManagerComponent =  ((T_ptr)0) ;
	DatabaseServices *lDatabaseServices =  ((T_ptr)0) ;
	T_boolean lDatabaseLoaded =  0 ;
	...
	lDatabaseLoaded = lDatabaseServices->getBooleanData(lDatabaseServices,  45 );

	 
	if (lDatabaseLoaded ==  1 )
	{_ATC_BLOC(1,0);{
		pThis->_checkDatabaseSwap(pThis);
		pThis->_updateFMSAirports(pThis);
		pThis->_updateBTVAirport(pThis);
		pThis->_updateAircraftSituation(pThis);
		pThis->_updateAirportToBeDisplayedInArcNav(pThis);
		pThis->_updateAirportToBeDisplayedInPlan(pThis);
		pThis->_updateMode(pThis);
		pThis->_updateAirportPriorityList(pThis);
		pThis->_updateMapManagementData(pThis);
		pThis->_updateFlightTest(pThis);
		pThis->_updateAirportServiceActivation(pThis);
	}}
	else
	{_ATC_BLOC(1,1);{
		pThis->_databaseSwapState = lDatabaseServices->getBooleanData(lDatabaseServices,  48 );
	}}
