...
_ATC_DECLARE(1,0x400C7F6CUL,0x4E6C3ED6UL,2,_ATC_TAB_PROC(1),0,0,1,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateBTVAirport.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateBTVAirport.c"
...
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateBTVAirport.c"
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateBTVAirport.c"
...
void AirportManager__updateBTVAirport(AirportManager *pThis) 
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,0);{
	...
	pThis->_BTVAirportChanged =  0 ;
	lAirportManagerComponent = CAirportManagerComponent->getInstance();
	lBTVServices =
		(BTVServices*)(lAirportManagerComponent->getConnectedFacet(lAirportManagerComponent,
													E_AIRPORT_MANAGER_BTV_SERVICES_RECEPTACLE_INDEX));

	pThis->_BTVAirport = lBTVServices->getBTVAirport(lBTVServices);
