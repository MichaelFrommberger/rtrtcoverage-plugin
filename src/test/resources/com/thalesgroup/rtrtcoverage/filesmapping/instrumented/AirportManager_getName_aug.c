...
_ATC_DECLARE(1,0x971764DUL,0x6B32588EUL,2,_ATC_TAB_PROC(1),0,0,1,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_getName.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_getName.c"
...
T_char *AirportManager_getName(AirportManager *pThis) 
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,0);{
     
	{_ATC_PROC(1,0);return "I_AIRPORT_MANAGER_TASK";}
