...
_ATC_DECLARE_BLOC(1,7)
_ATC_DECLARE(1,0x2B406919UL,0x435F06C1UL,2,_ATC_TAB_PROC(1),0,0,7,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__checkDatabaseSwap.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__checkDatabaseSwap.c"
...
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__checkDatabaseSwap.c"
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__checkDatabaseSwap.c"
...
#line 25 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__checkDatabaseSwap.c"
...
void AirportManager__checkDatabaseSwap(AirportManager *pThis)
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,6);{
     
	AirportManagerComponent *lAirportManagerComponent =  ((T_ptr)0) ;
	DatabaseServices *lDatabaseServices =  ((T_ptr)0) ;
	T_boolean lDatabaseSwapState =  0 ;
	T_int16 lAirportId =  -1 ;
	...
	lDatabaseSwapState = lDatabaseServices->getBooleanData(lDatabaseServices,  48 );

	 
	if (lDatabaseSwapState != pThis->_databaseSwapState)
	{_ATC_BLOC(1,4);{
		pThis->_databaseSwapState = lDatabaseSwapState;

		 
		pThis->_alternateAirport =  -1 ;
		pThis->_BTVAirport =  -1 ;
		pThis->_nearestAirport =  -1 ;
		pThis->_destinationAirport =  -1 ;
		pThis->_originAirport =  -1 ;
		pThis->_memorizedAirportInArcNav =  -1 ;
		pThis->_defaultAirport =  -1 ;
		pThis->_airportToBeDisplayedInArcNav =  -1 ;
		pThis->_destinationAirportOfLastFlight =  -1 ;

		if ((pThis->_mode == E_PLAN_MODE) && (pThis->_requestedAirportForDisplay !=  -1 ))
		{_ATC_BLOC(1,2);{
			 
			lAirportId	= lDatabaseServices->searchAirportByChar(lDatabaseServices, E_ICAO, &(pThis->_airportNameToBeDisplayedInPlan[0]));
			if (lAirportId !=  -1 )
			{_ATC_BLOC(1,0);{
				pThis->_requestedAirportForDisplay = lAirportId;
				pThis->_lastDisplayedAirportInPlan = lAirportId;
				pThis->_airportToBeDisplayedInPlan = lAirportId;
			}}
			else
			{_ATC_BLOC(1,1);{
				pThis->_requestedAirportForDisplay =  -1 ;
				pThis->_lastDisplayedAirportInPlan =  -1 ;
				pThis->_airportToBeDisplayedInPlan =  -1 ;
			}}
		}}
		else
		{_ATC_BLOC(1,3);{
