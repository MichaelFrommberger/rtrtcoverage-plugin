...
_ATC_DECLARE(1,0x1A160EUL,0x7342482EUL,2,_ATC_TAB_PROC(1),0,0,5,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAircraftSituation.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAircraftSituation.c"
...
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAircraftSituation.c"
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateAircraftSituation.c"
...
void AirportManager__updateAircraftSituation(AirportManager *pThis)
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,4);{
     
	AirportManagerComponent *lAirportManagerComponent =  ((T_ptr)0) ;
	AircraftLocalizationServices *lAircraftLocalizationServices =  ((T_ptr)0) ;

	lAirportManagerComponent = CAirportManagerComponent->getInstance();
	lAircraftLocalizationServices =
				(AircraftLocalizationServices*)(lAirportManagerComponent->getConnectedFacet
																			(lAirportManagerComponent,
																			E_AIRPORT_MANAGER_AIRCRAFT_LOCALIZATION_SERVICES_RECEPTACLE_INDEX));

	pThis->_aircraftLocationValidity = lAircraftLocalizationServices->getAircraftLocationValidity(lAircraftLocalizationServices);
	if (pThis->_aircraftLocationValidity ==  1 )
	{_ATC_BLOC(1,0);{
		pThis->_aircraftLatitude = lAircraftLocalizationServices->getAircraftLatitude(lAircraftLocalizationServices);
		pThis->_aircraftLongitude = lAircraftLocalizationServices->getAircraftLongitude(lAircraftLocalizationServices);
		pThis->_aircraftAltitude = lAircraftLocalizationServices->getAircraftAltitude(lAircraftLocalizationServices);
	}}
	else
	{_ATC_BLOC(1,1);{
		 
	}}
	pThis->_flightPhaseValidity = lAircraftLocalizationServices->getFlightPhaseValidity(lAircraftLocalizationServices);
	if (pThis->_flightPhaseValidity ==  1 )
	{_ATC_BLOC(1,2);{
		pThis->_flightPhase = lAircraftLocalizationServices->getFlightPhase(lAircraftLocalizationServices);
	}}
	else
	{_ATC_BLOC(1,3);{
	...
	pThis->_onGroundCondition = lAircraftLocalizationServices->getAircraftOnGround(lAircraftLocalizationServices);
	pThis->_nearestAirport = lAircraftLocalizationServices->getNearestAirport(lAircraftLocalizationServices);
