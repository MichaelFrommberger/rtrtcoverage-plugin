...
_ATC_DECLARE_BLOC(1,13)
_ATC_DECLARE(1,0x4C086177UL,0x6B3037CFUL,2,_ATC_TAB_PROC(1),0,0,13,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFlightTest.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFlightTest.c"
...
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFlightTest.c"
...
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFlightTest.c"
...
#line 25 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFlightTest.c"
#line 26 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFlightTest.c"
#line 27 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFlightTest.c"
...
#line 28 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFlightTest.c"
...
void AirportManager__updateFlightTest(AirportManager *pThis)
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,12);{
	...
	MapObjectServices *lAirportObject =  ((T_ptr)0) ;
	T_PtrChar lAirportICAO =  ((T_ptr)0) ;
	T_uint32 lI = 0;
	T_uint32 lLength = 0;
	...
	if (pThis->_defaultAirport !=  -1 )
	{_ATC_BLOC(1,4);{
		lAirportObject = lDatabaseServices->getAirportInstance(lDatabaseServices, pThis->_defaultAirport);
		lAirportICAO = lMapObjectServices->getCharData(lMapObjectServices, lAirportObject,  11 );

		lLength = CStringUtilities->length(lAirportICAO);

		{_ATC_LOOP_bef(1,1);for (lI = 0 ; lI < lLength ; lI++)
		{_ATC_LOOP_in(1,1);{_ATC_BLOC(1,0);{
			FT_ICAO_OF_THE_DEFAULT_ARPT.data[lI] = (T_CHAR)lAirportICAO[lI];
		}}}}
		FT_ICAO_OF_THE_DEFAULT_ARPT.length = (T_INT)lLength;
	}}
	else
	{_ATC_BLOC(1,5);{
	...
	if (pThis->_airportToBeDisplayedInPlan !=  -1 )
	{_ATC_BLOC(1,10);{
		lAirportObject = lDatabaseServices->getAirportInstance(lDatabaseServices, pThis->_airportToBeDisplayedInPlan);
		lAirportICAO = lMapObjectServices->getCharData(lMapObjectServices, lAirportObject,  11 );

		lLength = CStringUtilities->length(lAirportICAO);

		{_ATC_LOOP_bef(1,7);for (lI = 0 ; lI < lLength ; lI++)
		{_ATC_LOOP_in(1,7);{_ATC_BLOC(1,6);{
			FT_ICAO_TO_BE_DISP_IN_PLAN.data[lI] = (T_CHAR)lAirportICAO[lI];
		}}}}
		FT_ICAO_TO_BE_DISP_IN_PLAN.length = (T_INT)lLength;
	}}
	else
	{_ATC_BLOC(1,11);{
