...
_ATC_DECLARE(1,0x5483839UL,0x2D287817UL,2,_ATC_TAB_PROC(1),0,0,1,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_initializeStaticClass.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_initializeStaticClass.c"
...
#line 1 "..\Includes\AirportManager_static_getInstance.hpp"
...
#line 20 "..\Includes\AirportManager_static_getInstance.hpp"
...
extern AirportManager *AirportManager_static_getInstance(void);


#line 25 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_initializeStaticClass.c"
#line 1 "..\Includes\AirportManager_static_initialize.hpp"
...
#line 20 "..\Includes\AirportManager_static_initialize.hpp"
...
extern void AirportManager_static_initialize(AirportManager *pInstance);


#line 26 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager_initializeStaticClass.c"

 
static AirportManagerClass StaticAirportManager;
...
void AirportManager_initializeStaticClass(void)
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,0);{
	 
	 
	
	 
	CAirportManager = &StaticAirportManager;

	 
	CAirportManager->getInstance = AirportManager_static_getInstance;
	CAirportManager->initialize = AirportManager_static_initialize;
