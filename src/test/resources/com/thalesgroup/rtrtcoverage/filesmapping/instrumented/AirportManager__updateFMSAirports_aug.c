...
_ATC_DECLARE(1,0x2D4B6614UL,0x79713016UL,2,_ATC_TAB_PROC(1),0,0,1,_ATC_TAB_BLOC(1),0,0)

#line 1 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFMSAirports.c"
...
#line 17 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFMSAirports.c"
...
#line 23 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFMSAirports.c"
...
#line 24 "R:\\DGWP-SW-A350\\DGWP_A350_UT\\DGWP_ANF\\Class_AirportManager\\Sources\\AirportManager__updateFMSAirports.c"
...
void AirportManager__updateFMSAirports(AirportManager *pThis) 
{_ATC_LINK(1);{_ATC_PROC(1,1);{_ATC_BLOC(1,0);{
     
	AirportManagerComponent *lAirportManagerComponent =  ((T_ptr)0) ;
	FlightPlanManagementServices *lFlightPlanManagementServices =  ((T_ptr)0) ;

	lAirportManagerComponent = CAirportManagerComponent->getInstance();
	lFlightPlanManagementServices =
		(FlightPlanManagementServices*)(lAirportManagerComponent->getConnectedFacet(lAirportManagerComponent,
																					E_AIRPORT_MANAGER_FLIGHT_PLAN_MANAGEMENT_SERVICES_RECEPTACLE_INDEX));

	pThis->_originAirport = lFlightPlanManagementServices->getOriginAirport(lFlightPlanManagementServices);

	pThis->_destinationAirport = lFlightPlanManagementServices->getDestinationAirport(lFlightPlanManagementServices);

	pThis->_destinationAirportOfLastFlight = lFlightPlanManagementServices->getDestinationAirportOfLastFlight(lFlightPlanManagementServices);

	pThis->_alternateAirport = lFlightPlanManagementServices->getAlternateAirport(lFlightPlanManagementServices);
