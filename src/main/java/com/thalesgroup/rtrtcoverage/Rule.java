...
/**
 * Rule object encapsulates the logic to mark {@link CoverageObject}s as
 * "failed". Such logic is used to mark builds as unstable when certain
 * condition is met.
 * <p>
 * For example, one can define a rule where "line coverage must be better than
...
public abstract class Rule implements Serializable, ExtensionPoint {
     ...
     * Serial ID.
     */
    private static final long serialVersionUID = 8940149865855860397L;
